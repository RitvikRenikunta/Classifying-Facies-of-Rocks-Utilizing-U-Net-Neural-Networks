...
Figure 7. The image shows a side-by-side comparison of		           Figure 8.The image shows a side-by-side comparison

the predicted labels from the model (the left image) and 		           of the predicted labels from the model (the left image) 

the true labels (the right image). This was taken from the	                           and the true labels (the right image). This was taken from the training set.					           from the testing set.
